...
import ruslan.galiev.myweather.setTemperatureFormatted
    ...
    class ViewHolder private constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: HourlyWeatherInformation) {
            ...
            when (item.type) {
                ...
                TimeStage.Sunset -> temperature.text = "Закат"
                TimeStage.Sunrise -> temperature.text = "Рассвет"
                TimeStage.Now -> temperature.text = "Сейчас"
            }
